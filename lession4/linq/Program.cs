...
class Program
{
    ...
    private static List<Education> _educationList = new();
    ...
    private static void Main()
    {
        ...
        Console.WriteLine("Alle Studenten, die Wirtschaft studieren und über 18 Jahre alt sind:");
        ...
        var studentsByEducation2 = _studentList
            .Join(_educationList, s => s.EducationID, e => e.EducationID, (s, e) => new { s, e })
